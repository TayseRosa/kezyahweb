      ...
      <div className="content">
        <div className="form-box">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn-submit">Cadastrar Tamanho</button>
          </form>

          {/* Listagem de Tamanhos Cadastrados */}
          <div>
            <h2 style={{ color:'#1e1e2f' }}>Tamanhos Cadastrados</h2>
            {tamanhos.length > 0 ? (
              <ul>
                {tamanhos.map((t, index) => (
                  <li style={{ color:'#1e1e2f' }} key={index}>{t.nome}</li>
                ))}
              </ul>
            ) : (
